...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Quesiton with a pub_date in the past are displayed on the index page.
        """
    ...
    def test_six_past_questions(self):
        """
        The question index page should display only the five most recent questions.
        """
        question1 = create_question(question_text="Too old question.", days=-30)
        question2 = create_question(question_text="Past question 1.", days=-1)
        question3 = create_question(question_text="Past question 2.", days=-2)
        question4 = create_question(question_text="Past question 3.", days=-3)
        question5 = create_question(question_text="Past question 4.", days=-4)
        question6 = create_question(question_text="Past question 5.", days=-5)
        response = self.client.get(reverse('polls:index'))
...
class QuestionResultViewTest(TestCase):
    ...
    def test_past_question(self):
        """
        The result view of a question with a pub_date in the past displays the question's result.
        """
        past_question = create_question(question_text="Past question.", days=-1)
